...
function updateInviewExmaple() {
    var target = eval($('[data-example-inview-item]').val());
...
module.exports = {
    ...
    _readConfigFromDom: function _readConfigFromDom() {
        ...
        Object.keys(this.config).map(function (key) {
            var attribute = 'viewport-' + key.toLowerCase();
            var value = parseInt(_this.root.data(attribute));
            if (value > 0) _this.config[key] = value;
        });
        return this;
    },
    ...
    _assureOffset: function _assureOffset(target) {
        var offsetY = 0;
    ...
    // External functions
    isTopInView: function isTopInView(target) {
        var offsetY = this._assureOffset(target) - this._addToolbar();
        return offsetY >= this.start && offsetY <= this.end;
    },
    scrollTo: function scrollTo(target, whenInView) {
        var offsetY = this._assureOffset(target);
...
},{"jquery":3,"lodash.merge":18}],3:[function(require,module,exports){
/*!
...
},{"lodash._bindcallback":8,"lodash._isiterateecall":11,"lodash.restparam":19}],10:[function(require,module,exports){
/**
...
},{"lodash._basefor":7,"lodash.isarguments":12,"lodash.keysin":17}],15:[function(require,module,exports){
(function (global){
/**
 * lodash 3.0.3 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
...
},{"lodash._getnative":10,"lodash.isarguments":12,"lodash.isarray":13}],17:[function(require,module,exports){
/**
...
},{"lodash.isarguments":12,"lodash.isarray":13}],18:[function(require,module,exports){
/**
...
},{"lodash._arraycopy":4,"lodash._arrayeach":5,"lodash._createassigner":9,"lodash.isarguments":12,"lodash.isarray":13,"lodash.isplainobject":14,"lodash.istypedarray":15,"lodash.keys":16,"lodash.toplainobject":20}],19:[function(require,module,exports){
/**
...
},{"lodash._basecopy":6,"lodash.keysin":17}]},{},[1]);
